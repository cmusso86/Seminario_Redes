...
![](capitulos/Rafa/ctrfac-feature.png){width="1400" height="100"}


![](capitulos/Rafa/ctrfac-results.png){width="1400" height="450"}
...
::: {.column width="50%"}
![](capitulos/Rafa/resnet.png){width="500" height="450"}
:::
...
::: {.nonincremental}
1. Strong representational capabilities;
2. Fitting capabilities; and
