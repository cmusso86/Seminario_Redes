...
-   **Tabular data**
  ...
  -  Values usually sampled from a normal distribution for each variable

-   **Text data**

  - Words turned on or off according to a bernoulli distribution

-  **Image data**

    - Mega-pixels turned on or off according to a bernoulli distribution
