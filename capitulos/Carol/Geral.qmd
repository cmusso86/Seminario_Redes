...
- Average marginal effect, independent features.
...
- Dependent features
- Conditional distribution: differences in predictions. 
...
```{r echo=F, fig.align='center'}
knitr::include_graphics("capitulos/Carol/img/sensitivity.png")
```
