...
- Machine learning model is fast and cheap, whereas the training of a human is time consuming and costly.
...
## Introduction: Interpretacao modelos classicos
- comparacao com regressao linear ou logistica
...
## Introduction : modelos mais complexos
